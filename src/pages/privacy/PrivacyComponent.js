...
export default ({ model }) => (
  <div>
    <Section style={{ background: "#ececec" }}>
      <SectionSlogan>Privacy Policy</SectionSlogan>
      <SectionParagraph>
      ...
      <SectionParagraph>
        ...
        We collect information from you when you register on our site, Open a
        Support Ticket or enter information on our site, Provide us with
      ...
      <SectionParagraph>
        ...
        Layer (SSL) technology. We implement a variety of security measures when
      ...
      <SectionParagraph>
        ...
        <ul>
          <li>
            Understand and save user's preferences for future visits. You can
            ...
            properly. Third-party disclosure We do not sell, trade, or otherwise
            ...
            other parties for marketing, advertising, or other uses. Third-party
            links We do not include or offer third-party products or services on
            our website. Google Google's advertising requirements can be summed
            ...
            future. California Online Privacy Protection Act CalOPPA is the
          ...
          <li>
            ...
            link to it on our home page or as a minimum, on the first
      ...
      <SectionParagraph>
        <h4>How does our site handle Do Not Track signals? </h4>We honor Do Not
        Track signals and Do Not Track, plant cookies, or use advertising when a
        Do Not Track (DNT) browser mechanism is in place.
      </SectionParagraph>
      <SectionParagraph>
        <h4>Does our site allow third-party behavioral tracking? </h4>It's also
      ...
      <SectionParagraph>
        ...
        <ul>
          <li>
            Within 1 business day We also agree to the Individual Redress
